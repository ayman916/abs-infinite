      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <FadeIn delay={0.15}>
          <div className="mt-16">
            ...
            <p className="mt-6 text-charcoal-500 text-[17px]">Options may include:</p>
            <ul className="mt-3 space-y-2 text-charcoal-600 text-[17px]">
              {[
                "Full acquisitions",
        ...
        <FadeIn delay={0.2}>
          <div className="mt-16">
            ...
            <p className="mt-6 text-charcoal-500 text-[17px]">We prioritize:</p>
            <ul className="mt-3 space-y-2 text-charcoal-600 text-[17px]">
              {[
